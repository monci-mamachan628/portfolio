...
<TimelineItem direction="left">
  ...
  <div className="w-1/2 pr-8 flex justify-end">
    <div className="bg-transparent border-2 border-purple-400 rounded-xl p-6 text-foreground max-w-md text-center shadow-lg">
      ...
      <p className="text-sm text-muted-foreground text-justify">
        Managed high-volume reservation data to ensure 100% pricing and 
        inventory accuracy, directly supporting revenue management and 
        preventing booking losses in a fast-paced, high-pressure environment. 
        Communicated insights and operational issues clearly with front-office 
        and operations teams to improve coordination and efficiency.
      </p>
    </div>
  </div>
